...
func _ready():
	...
	if Global2.evaluations["questions"][0] != "":
		...
		if Global2.evaluations["answers"][0] != "":
		...
		if Global2.evaluations["answers"][1] != "":
		...
		if Global2.evaluations["answers"][2] != "":
		...
		if Global2.evaluations["answers"][3] != "":
	...
	if Global2.evaluations["questions"][1] != "":
		...
		if Global2.evaluations["answers"][4] != "":
		...
		if Global2.evaluations["answers"][5] != "":
		...
		if Global2.evaluations["answers"][6] != "":
		...
		if Global2.evaluations["answers"][7] != "":
	...
	if Global2.evaluations["questions"][2] != "":
		...
		if Global2.evaluations["answers"][8] != "":
		...
		if Global2.evaluations["answers"][9] != "":
		...
		if Global2.evaluations["answers"][10] != "":
		...
		if Global2.evaluations["answers"][11] != "":
	...
	if Global2.evaluations["questions"][3] != "":
		...
		if Global2.evaluations["answers"][12] != "":
		...
		if Global2.evaluations["answers"][13] != "":
		...
		if Global2.evaluations["answers"][14] != "":
		...
		if Global2.evaluations["answers"][15] != "":
	...
	if Global2.evaluations["questions"][4] != "":
		...
		if Global2.evaluations["answers"][16] != "":
		...
		if Global2.evaluations["answers"][17] != "":
		...
		if Global2.evaluations["answers"][18] != "":
		...
		if Global2.evaluations["answers"][19] != "":
